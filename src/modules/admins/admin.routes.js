...
router.post('/create-admin', Authentication, Authorization, adminController.createAdmin);
...
router.put('/update-admin/:id', Authentication, Authorization, adminController.updateAdmin);
